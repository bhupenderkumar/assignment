  ...
  return (
    <>
      ...
      <Helmet>
        ...
        <meta property="og:url" content={`${window.location.origin}/play/assignment/${assignmentId}`} />
        ...
        <link rel="canonical" href={`${window.location.origin}/play/assignment/${assignmentId}`} />
