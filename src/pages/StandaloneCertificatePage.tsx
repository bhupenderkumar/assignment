...
const StandaloneCertificatePage: React.FC = () => {
  ...
  const [submission, setSubmission] = useState<InteractiveSubmission | null>(null);
    ...
    <div className="standalone-certificate-page">
      ...
      <div className="certificate-header print:hidden">
        ...
        <div className="flex space-x-2">
          ...
          <button
            onClick={handlePrint}
            className="px-4 py-2 rounded-lg bg-gray-100 text-gray-800 font-medium flex items-center space-x-2 hover:bg-gray-200 transition-colors duration-300 border border-gray-200"
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="certificate-content">
        <motion.div
          ...
          className="shadow-lg rounded-lg overflow-hidden bg-white p-4 print:shadow-none print:p-0"
        >
          <CertificateTemplate
